...
/*
    Result                           # of obs.
    -----------------------------------------
    not matched                     2,417,434
        from master                         0  (_merge==1)
        from using                  2,417,434  (_merge==2)

    matched                             2,414  (_merge==3)
    -----------------------------------------
*/
gen have_data = 0
...
//save "$dir/working_data/temp/TZLG.dta", replace
...
save "$dir/working_data/TZ_pm25_and_so2_lg.dta", replace
