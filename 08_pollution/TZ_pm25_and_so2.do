...
order lat lon year month day dist
...
drop if dist ==""
save "$dir/working_data/temp/TZZZZ.dta", replace
...
save "$dir/working_data/TZ_pm25_and_so2_ld.dta", replace

use "$dir/working_data/TZ_pm25_and_so2_lg.dta", replace
merge 1:1 dist year month day using "$dir/working_data/TZ_pm25_and_so2_ld.dta"
drop _merge
