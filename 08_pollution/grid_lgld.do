...
use "$dir/working_data/2008~2015_pm25_and_so2_daily.dta", replace
/*
merge m:1 lat lon year month day using 
...
drop if (lat < -11) | (lat > 4)
drop if (lon < 29.375 | lon > 41.25)
***************************************
...
save "$dir/working_data/all_pm25_and_so2.dta", replace
